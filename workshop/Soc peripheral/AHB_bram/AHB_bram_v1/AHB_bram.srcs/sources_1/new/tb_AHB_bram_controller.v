...
//==============================================================================
    ...
    // HSELx   = 0;
        ...
        // 1. single写 0x0000_0004, data=0x11111111
        // @(posedge HCLK);
        // HSELx   = 1;
        // HADDR   = 32'h0000_0004;
        // HWRITE  = 1;
        ...
        // HMASTLOCK = 0;
        // HREADY  = 1;
        // HWDATA  = 32'hcafe_babe; // 数据无效

        // // 2. single读 0x0000_0004，写数据
        // @(posedge HCLK);
        // HSELx   = 0;
        // HADDR   = 32'h0000_0004;
        // HWRITE  = 0;
        ...
        // // 3. 字写 0x0000_0004, data=0x22222222
        // @(posedge HCLK);
        // HSELx   = 1;
        // HADDR   = 32'h0000_0004;
        // HWRITE  = 1;
        ...
        // // 5. 字节写 0x0000_0005, data=0xBBBBBBBB
        // @(posedge HCLK);
        // HSELx   = 1;
        // HADDR   = 32'h0000_0005;
        // HWRITE  = 1;
        ...
        // // 7. burst写（应报错）0x0000_0008, data=0x87654321
        // @(posedge HCLK);
        // HSELx   = 1;
        // HADDR   = 32'h0000_0008;
        // HWRITE  = 1;
